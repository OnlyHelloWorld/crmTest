...
<html>
<head>
<TITLE><s:property value="#linkMan==null?'添加':'修改'" /> 负责人</TITLE> 
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：负责人管理 &gt;<s:property value="#linkMan==null?'添加':'修改'" /> 负责人</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属供应商：</td>
								<td colspan="3">
								<input type="hidden" name="supplier.supplier_id" style="WIDTH: 180px" id="supplier_id" value="<s:property value="#linkMan.supplier.supplier_id" />" />
								<input type="text"  style="WIDTH: 180px" id="supplier_name" value="<s:property value="#linkMan.supplier.supplier_name" />"/>
