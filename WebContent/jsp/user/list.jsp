				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：系统管理 &gt; 权限管理</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR 		
													...
													<TD>
													<s:property value="#user.user_role" />
													</TD>
													
													<TD>
														<a href="${pageContext.request.contextPath }/UserAction_toEdit?user_id=<s:property value="#user.user_id" />">编辑权限</a>
													</TD>
												</TR>
												</s:iterator>
